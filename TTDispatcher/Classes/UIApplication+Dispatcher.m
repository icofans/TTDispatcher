...
dispatcherMethod(Class class,SEL selector)
{
    ...
    // 在TTDispatcherExchange实现
    Method newMethod = class_getInstanceMethod([TTDispatcherExchange class], NSSelectorFromString([NSString stringWithFormat:@"module_%@",oriSelName]));
